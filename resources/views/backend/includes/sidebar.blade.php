...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
			...
			<li class="{{ Active::pattern('admin/guest-book*') }} treeview">
                <a href="#">
                    <span>Guest Book</span>
                    <i class="fa fa-angle-left pull-right"></i>
                </a>               
				<ul class="treeview-menu {{ Active::pattern('guest/guest-book*', 'menu-open') }}" style="display: none; {{ Active::pattern('admin/guest-book*', 'display: block;') }}">
                    <li class="{{ Active::pattern('guest-book') }}">
                        {{ link_to('guest/guest-book', 'Guest Book') }}
                    </li>
                    <li class="{{ Active::pattern('new-guest-book') }}">
                        {{ link_to('guest/gallery', 'Gallery') }}
                    </li>
                </ul>
            </li>
        </ul><!-- /.sidebar-menu -->
